...
class Anket {
    ...
    //Статические методы - это те методы, которые доступны классу, доступны дочерним классам, но недоступны
    //экземплярам класса. Подробно можно ещё раз посмотреть тут: https://www.youtube.com/watch?v=OR0Xug9StOg
